...
const Contact = () => {
    const handleSubmit = (e) => {
        e.preventDefault()
        toast.success("Thank you for choice Us")
    }
    return (
        <div id='contact'>
            <section class="bg-white dark:bg-gray-900">
                <div class="max-w-7xl xl:px-0 px-6 py-12 mx-auto">
                    <div>
                        <LeftHeading title={"Contact us"} />
                    ...
                    <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                        <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">Bangladesh dhaka</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+0081312984</p>
                            </div>
                        </div>

                        <div class="p-4 py-6 md:p-8">
                            <form onSubmit={handleSubmit}>
                                <div class="-mx-2 md:items-center md:flex">
                                    <div class="flex-1 px-2">
                                        <label class="block mb-2 text-sm text-gray-600 dark:text-gray-200">First Name</label>
                                        <input type="text" placeholder="John " class="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border-2 border-blue-200  dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                    </div>
                                ...
                                <div class="w-full mt-4">
                                    ...
                                    <textarea class="block w-full h-32 px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border-2 border-blue-200  md:h-56 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Message"></textarea>
                                </div>

                                <button onClick={handleSubmit}
                                    type='submit' class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                    Send message
                                </button>
                            </form>
                        </div>
