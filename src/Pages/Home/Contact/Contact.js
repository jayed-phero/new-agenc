    ...
    return (
        <div>
            <section class="bg-purple-200 dark:bg-gray-900">
                <div class="max-w-6xl xl:px-0 px-6 py-12 mx-auto">
                    <div>
                    ...
                    <div class="gri grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                        ...
                        <div class="p-4 py-6 rounded-lg dark:bg-gray-800 md:p-8 max-w-md mx-auto">
                            <form>
                                <div class="">
                                    <input type="text" placeholder="Name" className='outline-none border-b-2 border-white py-2 px-5 w-full bg-transparent placeholder-gray-400 text-gray-700' />
                                </div>

                                <div class="mt-4">
                                <input type="email" placeholder="Email Address" className='outline-none border-b-2 border-white py-2 px-5 w-full bg-transparent placeholder-gray-400 text-gray-700' />
                                </div>

                                <div class="w-full mt-4">
                                <textarea type="text" placeholder="Message" className='outline-none border-b-2 border-white py-2 px-5 w-full bg-transparent placeholder-gray-400 text-gray-700 h-32' ></textarea>
                                </div>

                                <button class="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-purple-500 rounded-lg hover:bg-purple-800 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                    Send message
                                </button>
                            </form>
                        </div>
