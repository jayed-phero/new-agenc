...
const HomeCon = () => {
    return (
        <div>
            <div class="w-full bg-center bg-cover portfolioBG">
            <div class="max-w-7xl flex flex-col px-6 py-20 mx-auto space-y-6 lg:py-20 lg:flex-row lg:items-center lg:justify-center xl:px-0 gap-10 md:gap-0">
                    ...
                    <div class="flex items-center justify-center w-full h-56 md:h-64 lg:h-96 lg:w-1/2 ">
