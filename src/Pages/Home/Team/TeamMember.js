            ...
            <section class="bg-purple-100 py-7 dark:bg-gray-900">
                <div class="max-w-6xl xl:px-0 px-6 py-10 mx-auto">
                    ...
                    <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
                        <div class="flex flex-col items-center p-8 transition-colors duration-300 transform border border-purple-500 cursor-pointer rounded-xl hover:border-transparent group hover:bg-purple-800 dark:border-gray-700 dark:hover:border-transparent">
